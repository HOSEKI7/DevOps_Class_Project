...
const HomePage = () => {
  return (
    <div className="">
      <div className="h-[90vh] bg-[url('https://r4.wallpaperflare.com/wallpaper/417/748/887/geforce-gtx-titan-z-computer-gpus-wallpaper-9836cc3a2fec17097eb0e93252e9dbf0.jpg')] bg-cover bg-center bg-black/60 bg-blend-multiply">
